            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        <li class="nav-item dropdown {{request()->is('/products?data_from=latest')?'active':''}}">
                            <a class="nav-link" href="/products?data_from=latest">{{ \App\CPU\translate('Shop')}}</a>
                        </li>
                        <li class="nav-item dropdown {{request()->is('/contacts')?'active':''}}">
                            <a class="nav-link" href="/contacts">{{ \App\CPU\translate('Contact Us')}}</a>
                        </li>
