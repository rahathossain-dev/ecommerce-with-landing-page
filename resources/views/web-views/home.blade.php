...
@section('content')
    ...
    {{--categries--}}
    <section class="container rtl" style="padding-top: 40px !important; padding-bottom: 20px !important">
        <!-- Heading-->
                    ...
                    <div class="category_div" style="height: 132px; width: 100%;">
                        <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">
                            <img style="vertical-align: middle; padding: 16%;height: 100px"
                                 ...
                                 alt="{{$category->name}}">
                            <p class="text-center small" style="margin-top: -5px;">{{Str::limit($category->name, 17)}}</p>
                        </a>
                    </div>
                @endforeach
            </div>
    ...
    @if (isset($flash_deals))
        <div class="container mt-4" style="padding-top: 20px !important; padding-bottom: 20px !important">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="owl-carousel owl-theme mt-4" id="flash-deal-slider">
    ...
    @if(count($featured_products) > 0)
        <section class="container rtl" style="padding-top: 20px !important; padding-bottom: 20px !important">
            <!-- Heading-->
            <div class="section-header">
                <div class="feature_header">
    ...
    @if(isset($featured_deals))
        <section class="container featured_deal rtl" style="padding-top: 20px !important; padding-bottom: 20px !important">
            <div class="row">
    ...
    @endif
    {{--deal of the day--}}
    <div class="container rtl"  style="padding-top: 20px !important; padding-bottom: 20px !important">
        <div class="row">
    ...
    @foreach($home_categories as $category)
        <section class="container rtl" style="padding-top: 20px !important; padding-bottom: 20px !important">
            ...
            <div class="section-header">
                ...
                <div>
                    <a class="btn btn-outline-accent btn-sm viw-btn-a btn_view_all"
            ...
            <div class="row mt-2 mb-3">
                @foreach($category['products'] as $key=>$product)
                    <div class="col-xl-2 col-sm-3 col-6" style="padding-top: 20px !important; padding-bottom: 20px !important">
                        @include('web-views.partials._single-product',['product'=>$product])
                    </div>
                @endforeach
            </div>
    ...
    <!-- Product widgets-->
    {{-- <section class="container pb-4 pb-md-5 rtl" style="padding-top: 20px !important; padding-bottom: 20px !important">
        <div class="row">
            <!-- Bestsellers-->
