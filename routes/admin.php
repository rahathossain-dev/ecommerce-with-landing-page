...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'landing-page', 'as' => 'landingPage.'], function () {
            Route::get('/list', [LandingPageController::class, 'listLandingPage'])->name('list');
            Route::get('/setup/{id}', [LandingPageController::class, 'setupLandingPage'])->name('setup');
            Route::post('/store', [LandingPageController::class, 'store'])->name('store');
            Route::post('/setup-store', [LandingPageController::class, 'setupStore'])->name('setupStore');
            Route::get('/orders', [LandingPageController::class, 'addLandingPage'])->name('orders');


            Route::group(['prefix' => 'zone', 'as' => 'zone.'], function () {
                Route::get('/zone', [LandingPageController::class, 'zoneAll'])->name('zoneAll');
                Route::post('/store', [LandingPageController::class, 'zoneStore'])->name('zoneStore');
                Route::get('/edit/{id}', [LandingPageController::class, 'zoneEdit'])->name('zoneEdit');
                Route::post('/delete', [LandingPageController::class, 'zoneDelete'])->name('zoneDelete');
                Route::post('/delevery-charge-store', [LandingPageController::class, 'deleveryChargeStore'])->name('deleveryChargeStore');
                Route::get('/delevery-charge-edit/{id}', [LandingPageController::class, 'deleveryChargeEdit'])->name('deleveryChargeEdit');
                Route::post('/delevery-charge-update', [LandingPagecontroller::class, 'deleveryChargeUpdate'])->name('deleveryChargeUpdate');
                Route::post('/delevery-charge-delete', [LandingPagecontroller::class, 'deleveryChargeDelete'])->name('deleveryChargeDelete');
                Route::get('/delevery-charge', [LandingPageController::class, 'deleveryCharge'])->name('delevery-charge');
